...
sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"اولین",sLast:"آخرین",sNext:"بعدی",sPrevious:"قبلی"},sEmptyTable:"داده ای برای نمایش وجود ندارد",sInfo:"نمایش _START_ تا _END_ از _TOTAL_ مورد",sInfoEmpty:"نمایش 0 تا 0 از 0 مورد",sInfoFiltered:"(filtered from _MAX_ total entries)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"نمایش _MENU_ مورد",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"جستجو:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"No matching records found"},
